...
namespace Myrcon.Plugins.Test.Tests {
    public class TestPluginsIsolation : CoreController {
        ...
        protected ICommandResult TestPluginsIsolationCleanCurrentAppDomain(Command command, Dictionary<String, CommandParameter> parameters) {
        ...
        protected ICommandResult TestPluginsIsolationWriteToDirectory(Command command, Dictionary<String, CommandParameter> parameters) {
