...
namespace Potato.Core.Packages {
    /// <summary>
    /// Series of helpers to convert between Nuget packages and Potato packages.
    /// </summary>
    public static class PackageFactory {
        /// <summary>
        /// Takes a NuGet package and creates a new PackageModel with similar data
        /// </summary>
        /// <remarks>IPackage isn't used outside of Potato.Core and Potato.Service, plugins do not know the type.</remarks>
