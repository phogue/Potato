...
namespace Potato.Net.Shared.Test.Actions {
    [TestFixture]
    public class TestActions {

        /// <summary>
        /// Test that all non-static classes within the Potato.Net.Shared.Actions namespace
        ...
        public void TestClassesAreSerializable() {
            var nonSerializableTypes = typeof(ITruth).Assembly
                ...
                .Where(type => type.Namespace != null && type.Namespace.Equals("Potato.Net.Shared.Actions"))
