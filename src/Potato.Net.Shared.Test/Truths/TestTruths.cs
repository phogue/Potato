...
namespace Potato.Net.Shared.Test.Truths {
    ...
    public class TestTruths {
        /// <summary>
        /// Test that all non-static classes within the Potato.Net.Shared.Truths namespace
        ...
        public void TestClassesAreSerializable() {
            IEnumerable<Type> nonSerializableTypes = typeof(ITruth).Assembly
                ...
                .Where(type => type.Namespace != null && type.Namespace.StartsWith("Potato.Net.Shared.Truths"))
