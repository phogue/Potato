...
namespace Procon.Core.Test.Packages {
    ...
    public class TestCommandPackagesUninstallPackage {
        ...
        public void TestResultInsufficientPermissions() {
            ...
            CommandResult result = packages.Tunnel(CommandBuilder.PackagesUninstallPackage("id").SetOrigin(CommandOrigin.Remote).SetUsername("Phogue"));
        ...
        public void TestResultInvalidParameter() {
            ...
            CommandResult result = packages.Tunnel(CommandBuilder.PackagesUninstallPackage("").SetOrigin(CommandOrigin.Local));
        ...
        public void TestResultDoesNotExists() {
            ...
            CommandResult result = packages.Tunnel(CommandBuilder.PackagesUninstallPackage("this-does-not-exist").SetOrigin(CommandOrigin.Local));
        ...
        public void TestResultAlreadyExists() {
            ...
            CommandResult result = packages.Tunnel(CommandBuilder.PackagesUninstallPackage("A").SetOrigin(CommandOrigin.Local));
