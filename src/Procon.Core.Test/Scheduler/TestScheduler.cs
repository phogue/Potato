...
namespace Procon.Core.Test.Scheduler {
    ...
    public class TestScheduler {
        ...
        public void TestTaskConditionalEvent() {
            ...
            var tasks = new TaskController(10) {
                Enabled = true
            };
            ...
            var now = new DateTime(2000, 1, 1, 1, 1, 1, 0);
            tasks.Tick(now);
        ...
        public void TestTaskEvent() {
            ...
            tasks.Add(new Task()).Tick += new Task.TickHandler((sender, e) => eventCount++);
        ...
        public void TestTaskInternalEvent() {
            ...
            tasks.Add(new Task()).Tick += new Task.TickHandler((sender, e) => autoEvent.Set());
