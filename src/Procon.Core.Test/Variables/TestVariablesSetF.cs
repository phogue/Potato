...
namespace Procon.Core.Test.Variables {
    [TestFixture]
    public class TestVariablesSetF {
        [SetUp]
        ...
        public void TestValue() {
            ...
            CommandResultArgs result = variables.Tunnel(CommandBuilder.VariablesSetF("key", "value").SetOrigin(CommandOrigin.Local));
        ...
        public void TestEmptyKeyValue() {
            ...
            // Set an archive variable
            CommandResultArgs result = variables.Tunnel(CommandBuilder.VariablesSetF(String.Empty, "value").SetOrigin(CommandOrigin.Local));
        ...
        public void TestInsufficientPermission() {
            ...
            CommandResultArgs result = variables.Tunnel(CommandBuilder.VariablesSetF("key", "value").SetUsername("Phogue").SetOrigin(CommandOrigin.Remote));
