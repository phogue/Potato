...
namespace Procon.Database.Serialization.Test.MongoDb {
    ...
    public class TestSerializerMongoDbFindImplicit : TestSerializerFind {
        ...
        public override void TestSelectAllFromPlayerWhereKdrGreaterThanEqualTo31F() {
            ISerializer serializer = new SerializerMongoDb();
            ICompiledQuery serialized = serializer.Parse(this.TestSelectAllFromPlayerWhereKdrGreaterThanEqualTo31FImplicit).Compile();
        ...
        public override void TestSelectAllFromPlayerWhereKdrLessThanEqualTo31F() {
            ISerializer serializer = new SerializerMongoDb();
            ICompiledQuery serialized = serializer.Parse(this.TestSelectAllFromPlayerWhereKdrLessThanEqualTo31FImplicit).Compile();
