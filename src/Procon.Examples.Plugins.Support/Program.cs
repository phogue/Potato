...
namespace Procon.Examples.Plugins.Support {
    ...
    public class Program : PluginController {
        ...
        public ICommandResult TestSupportToKillPlayersUsingBranchBuilder(ICommand command, Dictionary<String, CommandParameter> parameters) {
        ...
        public ICommandResult TestSupportCustomBuildAndTest(ICommand command, Dictionary<String, CommandParameter> parameters) {
