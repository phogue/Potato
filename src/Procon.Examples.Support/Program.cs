...
namespace Procon.Examples.Support {
    /// <summary>
    ...
    public class Program : PluginController {
        ...
        public CommandResultArgs TestSupportToKillPlayersUsingBranchBuilder(Command command, Dictionary<String, CommandParameter> parameters) {
        ...
        public CommandResultArgs TestSupportCustomBuildAndTest(Command command, Dictionary<String, CommandParameter> parameters) {
