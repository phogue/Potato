    ...
    public class Sentence : List<Phrase>, ICloneable {
        ...
        public Sentence Parse(IFuzzyState state, string sentenceText) {
            this.AddRange(sentenceText.Wordify().Select(phrase => new Phrase() {
                Text = phrase
            }.Parse(state, "Procon.Fuzzy.Tokens.Primitive")).ToList());
            this.Refactor(state, "Procon.Fuzzy.Tokens.Primitive");

            //this.Collect(state);

            this.ReplaceRange(0, this.Count, this.Select(phrase => phrase.Parse(state, "Procon.Fuzzy.Tokens.Syntax")).ToList());
            this.Refactor(state, "Procon.Fuzzy.Tokens.Syntax");

            this.ReplaceRange(0, this.Count, this.Select(phrase => phrase.Parse(state, "Procon.Fuzzy.Tokens.Operator")).ToList());
            this.Refactor(state, "Procon.Fuzzy.Tokens.Operator");

            this.ReplaceRange(0, this.Count, this.Select(phrase => phrase.Parse(state, "Procon.Fuzzy.Tokens.Object")).ToList());
            this.Refactor(state, "Procon.Fuzzy.Tokens.Object");

            this.ReplaceRange(0, this.Count, this.Select(phrase => phrase.Parse(state, "Procon.Fuzzy.Tokens.Reduction")).ToList());
            this.Refactor(state, "Procon.Fuzzy.Tokens.Reduction");
        ...
        public Sentence Reduce(IFuzzyState state) {
            ...
            this.Reduce(state, TokenReflection.TokenReduceHandlers.Where(handler => handler.Key.Namespace.Contains("Procon.Fuzzy.Tokens.Operator.Arithmetic.FirstOrder")).ToList());
            this.Reduce(state, TokenReflection.TokenReduceHandlers.Where(handler => handler.Key.Namespace.Contains("Procon.Fuzzy.Tokens.Operator.Arithmetic.SecondOrder")).ToList());
            this.Reduce(state, TokenReflection.TokenReduceHandlers.Where(handler => handler.Key.Namespace.Contains("Procon.Fuzzy.Tokens.Operator.Arithmetic.ThirdOrder")).ToList());
            this.Reduce(state, TokenReflection.TokenReduceHandlers.Where(handler => handler.Key.Namespace.Contains("Procon.Fuzzy.Tokens")).ToList());
