...
namespace Procon.Fuzzy.Tokens.Object.Sets {
    ...
    public class SetsThingObjectToken : ThingObjectToken {
        ...
        */
        ...
        public static Phrase CombineSetAndSet(IFuzzyState state, Dictionary<String, Token> parameters) {
        ...
        */
        ...
        public static Phrase CombineSetThing(IFuzzyState state, Dictionary<String, Token> parameters) {
        ...
        public static Phrase CombineSetAndThing(IFuzzyState state, Dictionary<String, Token> parameters) {
            SetsThingObjectToken set = (SetsThingObjectToken) parameters["set"];
            AndLogicalOperatorToken and = (AndLogicalOperatorToken) parameters["and"];
            ThingObjectToken thing = (ThingObjectToken) parameters["thing"];
        ...
        */
        ...
        public static Phrase ReduceExcludingSet(IFuzzyState state, Dictionary<String, Token> parameters) {
