...
namespace Procon.Net.Console.Controls {
    ...
    public partial class PlayerPanel : UserControl {
        ...
        public PlayerPanel() {
            ...
            this.cboActions.Items.AddRange(
                new Object[] {
                    ...
                    new Move() {
                        MoveActionType = MoveActionType.Rotate
                    }
                    // new Move()
                }
            );
                    ...
                    if (player.SubItems.Count <= 1) {
                        player.SubItems.AddRange(
                            new ListViewItem.ListViewSubItem[] {
                                ...
                                new ListViewItem.ListViewSubItem() {
                                    Text = playerObject.Team.ToString()
                                }
                            }
                        );
                    }
                        ...
                        player.SubItems[7].Text = playerObject.Team.ToString();
                    }
                }
            }
        ...
        private void m_activeGame_GameEvent(Game sender, GameEventArgs e) {
            ...
            if (e.EventType == GameEventType.PlayerlistUpdated) {
            ...
            else if (e.EventType == GameEventType.PlayerJoin) {
                this.lsvPlayerlist.Items.Add(
                    new ListViewItem() {
                        Tag = e.Player
                    }
            ...
            else if (e.EventType == GameEventType.PlayerLeave) {
                ListViewItem player = this.lsvPlayerlist
                                          .Items
                                          .Cast<ListViewItem>()
                                          .Where(x => x.Tag == e.Player)
                                          .FirstOrDefault();
            ...
            else if (e.EventType == GameEventType.PlayerMoved) {
                this.RefreshPlayerlist();
            }
        }
        ...
        private void RefreshQuickAction() {
            if (this.cboActions.SelectedIndex >= 0 && this.lsvPlayerlist.SelectedItems.Count > 0) {
                ...
                if (this.cboActions.SelectedItem is Kill) {
                    ...
                    move.Target = this.lsvPlayerlist.SelectedItems[0].Tag as Player;
                    move.Reason = this.txtReason.Text;
                }
                else if (this.cboActions.SelectedItem is Ban) {
                    Ban ban = this.cboActions.SelectedItem as Ban;

                    ban.Target = this.lsvPlayerlist.SelectedItems[0].Tag as Player;
        ...
        private void cboActions_DrawItem(object sender, DrawItemEventArgs e) {
            ...
            if (e.Index >= 0) {
                if (this.cboActions.Items[e.Index] is Kill) {
                    ...
                    e.Graphics.DrawString(
                        String.Format("Move.{0}", move.MoveActionType),
                        this.cboActions.Font,
                        SystemBrushes.ControlText,
                        e.Bounds.Left + 5,
                        e.Bounds.Top
                    ...
                    e.Graphics.DrawString(
                        String.Format("Ban.{0}.{1}", ban.BanActionType, ban.Time != null ? ban.Time.Context : TimeSubsetContext.None),
                        this.cboActions.Font,
                        SystemBrushes.ControlText,
                        e.Bounds.Left + 5,
                        e.Bounds.Top
