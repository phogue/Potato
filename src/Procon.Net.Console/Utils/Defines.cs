...
namespace Procon.Net.Console.Utils {
    public static class Defines {
        public static readonly string PROCON_NET_CONSOLE_EXE = "Procon.Net.Console.exe";
        public static readonly string PROCON_NET_CONSOLE_XML = "Procon.Net.Console.xml";
