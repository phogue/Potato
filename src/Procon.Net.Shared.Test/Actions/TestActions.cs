...
namespace Procon.Net.Shared.Test.Actions {
    [TestFixture]
    public class TestActions {

        /// <summary>
        /// Test that all non-static classes within the Procon.Net.Shared.Actions namespace
        ...
        public void TestClassesAreSerializable() {
            IEnumerable<Type> nonSerializableTypes = typeof(ITruth).Assembly
                ...
                .Where(type => type.Namespace != null && type.Namespace.Equals("Procon.Net.Shared.Actions"))
