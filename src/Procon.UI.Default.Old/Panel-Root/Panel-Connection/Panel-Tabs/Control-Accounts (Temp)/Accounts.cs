...
namespace Procon.UI.Default.Root.Connection.Tabs.Accounts
{
    [Extension(
        Alters    = new String[] { "ConnectionTabsLayoutControl" },
        Replaces  = new String[] { },
        DependsOn = new String[] { "Connection Tabs Layout" })]
    public class Accounts : IExtension
    {
        ...
        public string Name
        { get { return "Connection Tabs Accounts"; } }
        ...
        public bool Entry(Window root)
        {
            ...
            av.Header = Localizer.Loc("Procon.UI.Default.Root.Connection.Tabs.Accounts.Title");

            // Alter controls.
            connectionTabs.Items.Add(av);
