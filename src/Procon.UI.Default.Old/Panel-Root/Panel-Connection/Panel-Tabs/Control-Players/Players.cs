...
namespace Procon.UI.Default.Root.Connection.Tabs.Players
{
    [Extension(
    ...
    public class Players : IExtension
    {
        ...
        public string Name
        { get { return "Connection Tabs Players"; } }
        ...
        public bool Entry(Window root)
        {
            ...
            pv.Header = Localizer.Loc("Procon.UI.Default.Root.Connection.Tabs.Players.Title");
