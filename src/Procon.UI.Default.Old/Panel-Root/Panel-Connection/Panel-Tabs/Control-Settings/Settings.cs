...
namespace Procon.UI.Default.Root.Connection.Tabs.Settings
{
    [Extension(
    ...
    public class Settings : IExtension
    {
        ...
        public string Name
        { get { return "Connection Tabs Settings"; } }
        ...
        public bool Entry(Window root)
        {
            ...
            sv.Header = Localizer.Loc("Procon.UI.Default.Root.Connection.Tabs.Settings.Title");

            // Alter controls.
            connectionTabs.Items.Add(sv);
