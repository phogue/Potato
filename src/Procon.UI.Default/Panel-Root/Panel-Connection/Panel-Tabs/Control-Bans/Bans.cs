...
namespace Procon.UI.Default.Root.Connection.Tabs.Bans
{
    ...
    public class Bans : IExtension
    {
        ...
        public string Name
        { get { return "Connection Tabs Bans"; } }
        ...
        public bool Entry(Window root)
        {
            ...
            // Setup my controls.
            BansView bv = new BansView();
            bv.Header = Localizer.Loc("Procon.UI.Default.Root.Connection.Tabs.Bans.Title");

            // Alter controls.
            connectionTabs.Items.Add(bv);
