...
namespace Procon.UI.Default.Root.Connection.Tabs.Maps
{
    [Extension(
    ...
    public class Maps : IExtension
    {
        ...
        public string Name
        { get { return "Connection Tabs Maps"; } }
        ...
        public bool Entry(Window root)
        {
            ...
            // Setup my controls.
            MapsView mv = new MapsView();
            mv.Header = Localizer.Loc("Procon.UI.Default.Root.Connection.Tabs.Maps.Title");

            // Alter controls.
            connectionTabs.Items.Add(mv);
