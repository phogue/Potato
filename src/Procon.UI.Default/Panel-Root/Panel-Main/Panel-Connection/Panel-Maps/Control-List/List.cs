...
namespace Procon.UI.Default.Root.Main.Maps.List
{
    ...
    public class List : IExtension
    {
        ...
        private InfinityDictionary<String, Object>   tProps = ExtensionApi.Properties["Main"]["Maps"]["List"];
        private InfinityDictionary<String, ICommand> tCmmds = ExtensionApi.Commands["Main"]["Maps"]["List"];
